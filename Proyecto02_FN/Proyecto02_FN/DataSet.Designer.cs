...
namespace Proyecto02_FN {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientesRow AddClientesRow(int ID, string Cedula, string Nombre, string Direccion, string Telefono) {
...
namespace Proyecto02_FN.DataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([ID], [Cedula], [Nombre], [Direccion], [Telefono]) " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Clientes] SET [ID] = @ID, [Cedula] = @Cedula, [Nombre] = @Nombre, [" +
                "Direccion] = @Direccion, [Telefono] = @Telefono WHERE (([ID] = @Original_ID))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SERVICIOSConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Cedula, Nombre, Direccion, Telefono FROM dbo.Clientes";
            ...
            this._commandCollection[2].CommandText = "SELECT        ID, Cedula, Nombre, Direccion, Telefono\r\nFROM            Clientes";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "INSERT INTO Clientes\r\n                         (ID, Cedula, Nombre, Direccion, Te" +
                "lefono)\r\nVALUES        (@ID,@Cedula,@Nombre,@Direccion,@Telefono)";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Cedula", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Cedula", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[4].CommandText = "UPDATE       Clientes\r\nSET                ID = @ID, Cedula = @Cedula, Nombre = @N" +
                "ombre, Direccion = @Direccion, Telefono = @Telefono\r\nWHERE        (ID = @Origina" +
                "l_ID)";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Cedula", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Cedula", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int FillBy(DataSet.ClientesDataTable dataTable) {
        ...
        public virtual DataSet.ClientesDataTable GetDataBy1() {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            DataSet.ClientesDataTable dataTable = new DataSet.ClientesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        public virtual int Insert(int ID, string Cedula, string Nombre, string Direccion, string Telefono) {
        ...
        public virtual int Update(int ID, string Cedula, string Nombre, string Direccion, string Telefono, int Original_ID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Cedula, string Nombre, string Direccion, string Telefono, int Original_ID) {
            return this.Update(Original_ID, Cedula, Nombre, Direccion, Telefono, Original_ID);
        }
        ...
        public virtual int InsertQuery(int ID, string Cedula, string Nombre, string Direccion, string Telefono) {
        ...
        public virtual int UpdateQuery(int ID, string Cedula, string Nombre, string Direccion, string Telefono, int Original_ID) {
